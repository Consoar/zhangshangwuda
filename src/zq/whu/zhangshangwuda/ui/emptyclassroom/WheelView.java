...
public class WheelView extends View {
	...
	// 当前值 以及Label的颜色
	public int VALUE_TEXT_COLOR = 0xFF2A9939;

	/** Items text color */
	// 每项的颜色
	public int ITEMS_TEXT_COLOR = 0xFF9C9C9C;
	...
	/** Default count of visible items items数目 */
	 ...
	 * @version 创建时间：2014年7月3日 下午4:03:48
	 * @param adapter
	 * 
	 */
	...
	private void initResourcesIfNecessary() {
		...
		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(
					R.drawable.wheel_selected_item);// 这里用于设置中间选中的地方的背景图
		}
